...
promptQuestions=[
    ...
    {
        question:"How to became a full stake developer?",
...
function getGeminiResponse(question, appendHistory){
    ...
    let resultTitle=`
        ...
        <img src="https://lh3.googleusercontent.com/ogw/AF2bZyhvXFExKWKzZiXHnuB8f1SyhfCpvx4BKvy4RVXelHAvYBE=s32-c-mo"/>
            <p>${question}</p>
        </div>
    `;
    ...
    const AIURL='https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyCd5zymLO6nQPtaSBtDZJbIggZbQFeRCvc';
    fetch(AIURL,{
        method:"POST",
        body:JSON.stringify({
    ...
    .then((data)=>{
        ...
        `;
        let newResponseData = newResponse.split(" ");
